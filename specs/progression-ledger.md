...
|-------|-------|--------------------|-----------------|--------|
| 2 | The Clockmaker's Attic (mechanical/time: gear ratios, clock hands, time zones, Roman numerals; attic-as-machine) | 6.0/10 (Validator official, rev 1.4.1, blind re-check confirmed 2026-08-08: z1 4.5 · z2 6.5 · z3 7.0 · z4 3.5; prior 6.5 measured obscurity not challenge — user-ratified) | z1 Main Attic 5.0 · z2 Movement Loft 7.0 · z3 Behind the Great Dial (hidden) 7.0 · z4 Clockmaker's Vault (hidden nested, reward room) 3.5 | SHIPPED TestFlight builds 15/16 (branch, unmerged); user cleared end-to-end on 16. Rev 1.4.1 clue-legibility pass (guide-dependence fix): blind re-check READY-WITH-TWEAKS, no beat guide-mandatory; teach-at-dormer micro-delta applied. Implementation batch → build 17 in flight. |
